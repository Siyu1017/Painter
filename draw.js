...
function importScript(u) {
    try {
        ...
        return console.warn("Unable to load script.");
    }
}

importScript("./dragger.min.js");
importScript("./hdcanvas.js");
importScript("./DouglasPeucker.js");
importScript("./RamerDouglasPeucker.js");
importScript("./VisvalingamWhyatt.js");
